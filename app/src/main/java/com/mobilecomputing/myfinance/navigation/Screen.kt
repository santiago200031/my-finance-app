...
sealed class Screen(val route: String, val label: String, val icon: ImageVector) {
    ...
    object Entries :
        Screen("entries", "Entries", Icons.Filled.Description)
    
    object AddEntry :
        Screen("add_entry", "Add Entry", Icons.Filled.Add)

    object EditEntry :
        Screen("edit_entry/{entryId}", "Edit Entry", Icons.Filled.Add)
    ...
    object AddContract :
        Screen("add_contract", "Add Contract", Icons.Filled.Add)
    ...
    object AddReminder :
        Screen("add_reminder", "Add Reminder", Icons.Filled.Alarm)
